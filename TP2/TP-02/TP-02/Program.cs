...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Leche m2 = new Leche(Producto.EMarca.Serenisima, "IOP852", ConsoleColor.Blue, Leche.ETipo.Descremada); //repetido con este
            ...
            Snacks a3 = new Snacks(Producto.EMarca.Sancor, "IOP852", ConsoleColor.Green); //repetido
